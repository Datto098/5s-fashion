<?php
// Script để thực hiện migration tạo bảng review_likes
// Chạy file này bằng cách gọi: php migrate_review_likes.php
...
echo "Bắt đầu migration: tạo bảng review_likes...\n";
...
try {
    ...
    echo "Lỗi khi thực hiện migration: " . $e->getMessage() . "\n";
}
