<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Tạo danh mục sản phẩm mới</p>
                </div>
                <div>
    ...
    <form action="/zone-fashion/admin/categories/store" method="POST" enctype="multipart/form-data" id="categoryForm">
        <div class="row">
            <!-- Main Content -->
            <div class="col-lg-8">
                <!-- Basic Information -->
                ...
                <!-- <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="metaDescription" name="meta_description" rows="3" maxlength="160"></textarea>
